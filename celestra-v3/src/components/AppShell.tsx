...
import { Target, ClipboardList, Menu, X, BarChart3, Map } from "lucide-react";
...
const nav = [
  ...
  { to: "/sizing",    label: "Sizing",            icon: BarChart3,     skill: "sizing-skill"               },
      ...
      */}
      ...
      <div className="flex flex-1 min-w-0 flex-col">
        ...
        <div className="hidden lg:flex items-center justify-between bg-slate-50 px-6 py-1.5 text-[11px] font-mono text-gray-400 tracking-wider border-b border-gray-100">
          <span>ANALYTICS PLATFORM · Project Context · Targeting · Sizing · Alignment</span>
